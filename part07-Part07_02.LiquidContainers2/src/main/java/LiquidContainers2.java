    ...
    public static void main(String[] args) {
        ...
        while (true) {
           ...
           if (commands.equals("move")) {
              ...
              if (integerVal > firstContainer.contains()) {
                  secondContainer.move(firstContainer.contains());
                  firstContainer.remove(firstContainer.contains());
              }
              
              if (integerVal > 0 && firstContainer.contains() - integerVal >= 0) {
                  secondContainer.move(integerVal);
                  firstContainer.remove(integerVal);
              }
